...
public class SourceBuilder<TSource> where TSource : ISource
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new SourceBuilder for the specified source.
    /// </summary>
    /// <param name="source">The source to build</param>
    internal SourceBuilder(TSource source)
    {
