...
- Follow the architecture principles outlined below
- Maintain zero-allocation requirements
- Use the established naming conventions
- Follow the file organization structure

## Architecture Principles

**CRITICAL: All code changes MUST follow these principles:**
...
**MANDATORY: All code MUST follow these requirements:**
...
**When adding new files, place them according to this structure:**
...
**See `07-code-quality.mdc` for detailed naming principles and guidelines (purpose-driven names, domain terminology, test naming patterns).**
